...
function renderHome() {
    ...
    const sList = document.getElementById('featured-services');
    if (sList) {
        sList.innerHTML = featServices.map(s => `
    ...
    const pList = document.getElementById('featured-products');
    if (pList) {
        pList.innerHTML = featProducts.map(p => `
...
async function confirmBooking() {
    ...
    try {
        ...
        showToast('Error al agendar. Intenta de nuevo.');
    }
}
